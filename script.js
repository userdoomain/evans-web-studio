...
// ===== Projects =====
const projects = [
  { img: "assets/proj-01.png", name: "Evolution Fit Studio", cat: "fitness", catLabel: "Fitness", desc: "Academia moderna com horários e planos.", url: "https://userdoomain.github.io/evolution-fit-studio/", keywords: ["academia", "fitness", "treino", "musculacao", "crossfit", "esporte"] },
  { img: "assets/proj-02.png", name: "Imperial Barber", cat: "barbearias", catLabel: "Barbearia", desc: "Barbearia estilo clássico com agendamento.", url: "https://userdoomain.github.io/imperial-barber-site/", keywords: ["barbearia", "barba", "cabelo", "barbeiro", "salao"] },
  { img: "assets/proj-03.png", name: "Nova Prime Store", cat: "servicos", catLabel: "Serviço", desc: "Loja moderna e rápida para catálogo.", url: "https://userdoomain.github.io/nova-prime-store/", keywords: ["loja", "store", "ecommerce", "vendas", "produtos", "roupas", "comercio"] },
  { img: "assets/proj-04.png", name: "Sabor e Brasa Premium", cat: "restaurantes", catLabel: "Restaurante", desc: "Restaurante com cardápio e destaques.", url: "https://userdoomain.github.io/sabor-e-brasa-premium/", keywords: ["restaurante", "comida", "lanchonete", "pizza", "hamburguer", "churrascaria", "bar", "cafe", "gastronomia"] },
  { img: "assets/proj-05.png", name: "Aurora Palace Hotel", cat: "hoteis", catLabel: "Hotel & Hospedagem", desc: "Hotel com quartos e galeria.", url: "https://userdoomain.github.io/aurora-palace-hotel/", keywords: ["hotel", "pousada", "hospedagem", "resort", "quartos", "turismo"] },
  { img: "assets/proj-06.png", name: "Advocacia Premium", cat: "servicos", catLabel: "Serviço", desc: "Escritório de advocacia profissional.", url: "https://userdoomain.github.io/advocacia/", keywords: ["advogado", "advocacia", "direito", "juridico", "escritorio"] },
  { img: "assets/proj-07.png", name: "Clínica Vida+", cat: "saude", catLabel: "Saúde", desc: "Clínica médica com especialidades.", url: "https://userdoomain.github.io/clinica/", keywords: ["clinica", "medico", "saude", "consultorio", "hospital", "pediatra", "cardiologista"] },
  { img: "assets/proj-08.png", name: "VetCare Veterinária", cat: "saude", catLabel: "Saúde", desc: "Clínica veterinária e serviços.", url: "https://userdoomain.github.io/clinica-veterinaria/", keywords: ["veterinario", "pet", "animal", "cachorro", "gato", "clinica pet"] },
  { img: "assets/proj-09.png", name: "Oficina Mecânica Pro", cat: "servicos", catLabel: "Serviço", desc: "Oficina automotiva e orçamentos.", url: "https://userdoomain.github.io/oficina-de-carro/", keywords: ["oficina", "carro", "mecanico", "auto", "veiculos", "pneu", "reparo"] },
  { img: "assets/proj-10.png", name: "Pet Shop Amigo", cat: "servicos", catLabel: "Serviço", desc: "Pet shop com banho, tosa e produtos.", url: "https://userdoomain.github.io/pet-shop/", keywords: ["petshop", "banho e tosa", "racao", "gatos", " caes"] },
  { img: "assets/proj-11.png", name: "Salão Beleza & Arte", cat: "servicos", catLabel: "Serviço", desc: "Salão de beleza e portfólio.", url: "https://userdoomain.github.io/salao-de-beleza/", keywords: ["salao de beleza", "cabelereiro", "manicure", "estetica", "depilacao"] },
  { img: "assets/proj-12.png", name: "Salão de Festas Celebrar", cat: "servicos", catLabel: "Serviço", desc: "Espaço de eventos e reservas.", url: "https://userdoomain.github.io/salao-de-festa/", keywords: ["salao de festas", "buffet", "eventos", "casamento", "aniversario"] }
];
